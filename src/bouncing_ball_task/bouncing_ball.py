...
class BouncingBallTask:
    ...
    def __str__(self):
        ...
        description = (
            ...
            f"    min_t_color_change_after_shape_change={self.min_t_color_change_after_shape_change},\n"
            f"    min_t_bounce_color_change_after_random={self.min_t_bounce_color_change_after_random},\n"
